        ...
        <div class="graph-outer">
          ...
          <button class="local-enlarge-icon" aria-label="Enlarge Local Graph">
            ...
            >
              ...
              {/* <path 
              d="M45.5,11.8v32.4c0,2.2-1.8,4-4,4H11.1c-2.2,0-4-1.8-4-4V11.8c0-2.2,1.8-4,4-4H41.5C43.7,7.8,45.5,9.6,45.5,11.8z M35.4,26.6
              L24.6,15.8c-0.8-0.8-2-0.8-2.8,0s-0.8,2,0,2.8l8.5,8.5h-19c-1.1,0-2,0.9-2,2s0.9,2,2,2h19l-8.5,8.5c-0.8,0.8-0.8,2,0,2.8
              c0.4,0.4,0.9,0.6,1.4,0.6s1-0.2,1.4-0.6l10.8-10.8C36.2,28.6,36.2,27.4,35.4,26.6z"
              /> */}
              <path d="M15 15v-5H8v12h12v-7h-5zm6 0h5v-5h12v12h-7v-5h-5v-2h-5zm-16 18v5h7v5H8V33h5zm32 0v5h-5v2h5v5h12V33H42v7h-7v-7z"/>
            </svg>
          </button>
