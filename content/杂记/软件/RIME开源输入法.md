...
输入法一般没啥问题就不用更新，暂时聚焦于方案的更新

以我使用的万象拼音方案为例，官方提供了万象更新UI工具，平时更新 词库与模型就行了，偶尔更新方案或者全量更新。（注意设置好白名单，避免被覆盖）
...
路线确定为 **<span style="color: #ff7575">全拼-双拼-音形结合码</span>**

### 方案A：优化版全拼（不换方案，白捡速度）

如果你不想换方案，Rime全拼本身还有**30%的提速空间**没被你挖掘：

1. **强制开启“逐词输入”**：不要一个字一个字打，养成打**四字词**的习惯（如“shengwujishu”打“生物技术”）。
2. **开启Rime的“自动造词”**：把常用长句（比如你的公司名、家庭地址）直接打成固定短语。
3. **关掉“模糊音”**（如果你开着）：模糊音会让候选词变多，精确输入强制降低重码率。

**结论**：如果你选这个，速度极限在 **60-80字/分**，够用但不惊艳。

### 方案B：小鹤双拼（最适合99%的人）

首选，我再给你补一个**Rime专属的避坑细节**：

- **致命误区**：很多人切双拼后，急着打文章，结果发现自己“脑子反应不过来韵母键位”。
- **正确姿势**：切双拼后的**前3天**，只做一件事——**用双拼写日记/聊天**，不要写正式文档。3天后肌肉记忆自动形成。
- 速度上限：轻松破 **100字/分**，且双手按键均衡，不累手。

### 方案C：小鹤音形（适合追求“零选字”的硬核玩家）

如果你选了这条，那我必须告诉你一个**血泪教训**：**千万不要单独学“音形”**，一定要在小鹤双拼（路线B）**打满1个月、彻底熟悉前两码**之后，再加后两码（字形）。

- 如果同时学音和形，大脑会直接过载，你大概率在第5天放弃。
- 速度上限：**130-160字/分**，全程不看候选框，打古文都行。
...
- RIME+雾凇拼音方案+万象大模型（放弃，万象已成熟，选万象方案）: [全平台方案](https://www.ctrlife.cn/posts/Technology/Rime+%E9%9B%BE%E5%87%87%E6%8B%BC%E9%9F%B3+%E4%B8%87%E8%B1%A1%E5%A4%A7%E6%A8%A1%E5%9E%8B%E7%9A%84%E5%85%A8%E5%B9%B3%E5%8F%B0%E8%BE%93%E5%85%A5%E6%96%B9%E6%A1%88)
