...
> [!warning] 学习本文的前提条件
> 掌握[开源魔法-链接导入版](科学/开源魔法-链接导入版.md)的内容，**<span style="color: #ff7575">并在你的所有相关设备开启魔法。</span>**
...
- 更多使用技巧
	...
	- [降低延迟方案总结](https://www.bilibili.com/opus/691911204352819201)：B站UP总结的方案
		...
		- NAT类型
		- [zerotier](游戏/远程游戏/网络条件/zerotier虚拟局域网.md)+ moon +Parsec：**<span style="color: #ff7575">当前使用方案</span>**
