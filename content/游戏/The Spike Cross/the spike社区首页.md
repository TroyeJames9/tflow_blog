...
> 4. PC端访问本网站时，**光标可停留在超链接文本上进行预览**，从而无需进行链接跳转。例子：[这是个超链接文本](游戏/The%20Spike%20Cross/游戏安装教程/游戏安装的前置条件.md)
...
- [**the spike安装教程**](游戏/The%20Spike%20Cross/游戏安装教程/游戏安装的前置条件.md)
