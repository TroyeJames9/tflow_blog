...
2. 破解包括全角色满突破与原版劳尔。
3. 手机**必须支持谷歌服务才可以使用私服破解**！可通过电脑的安卓模拟器**mumuplayer、LDplayer**等 使用私服破解。这些模拟器的外网版本均内置谷歌服务。推荐mumuplayer 12。
4. 每次开启破解时，都会重置游戏设置，**比如语言、新手模式、助跑等设置**。会稍微麻烦点，但无伤大雅。
...
7. 无法在破解版中进行球员招募，已被开发者屏蔽掉招募板块
## 如何购买密钥

> [!EXAMPLE] 需要代购？
> [联系tflow](杂记/如何联系tflow？.md)购买，提供安装包与密钥与一切和资源和指导。

**<span style="color: #ff7575"> %% 我需要先确认他们不输入密钥直接登陆时，是否报错均为???再让他们购买 %%</span>**
