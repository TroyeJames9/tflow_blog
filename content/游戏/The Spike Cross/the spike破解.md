...
1. 密钥一经使用，只能在该设备上使用。  严禁在其他设备使用该密钥，否则会被破解服务器封禁。**1个密钥仅适用于1个设备**。
2. 手机**必须支持谷歌服务且能访问外网，才可以使用私服破解**！如手机不支持谷歌服务，可通过电脑的安卓模拟器**mumuplayer、LDplayer**等 使用私服破解。这些模拟器的外网版本均内置谷歌服务。推荐mumuplayer 12。
3. 破解包括全角色满突破与原版劳尔。**可用于所有比赛**！
4. 每次开启破解时，都会从破解服务器读取破解的货币数量（球芒币、经验值、排球等），仅适用于破解球员加点，**一旦经过签到、比赛获胜等方式与正版服务器进行交互，则会读取正版服务器里的各类货币数量，此时不可对破解球员进行加点。 重新开启破解，即可再次从破解服务器读取破解的货币数量。**
5. 根据第4点，建议开启破解后第一时间就给破解球员都进行加点，这些球员数据会保存到破解服务器中，下次启动无需再次加点。
6. 根据第4点，破解版中的球员招募可在读取正版服务器货币数量后进行。
## 如何购买密钥
