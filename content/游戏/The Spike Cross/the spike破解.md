...
私服订阅的核心功能为：**全5突球员**，**全装饰**，**破解100%劳尔**，**自动获胜加分功能（EN+/MY+)**
...
> - 已掌握 [the spike cross安卓版安装教程](游戏/The%20Spike%20Cross/游戏获取方式/the%20spike%20cross安卓版安装教程.md) 教程的所有内容，并按照该教程在设备里（并非ourplay里）装正版the spike cross并已通过google登陆
> - 设备保持代理开启的状态
...
- 按三次音量降低按钮即可启用自动获胜功能，即 EN+ / MY+。（EN+为增加己方得分，MY+为增加对方得分）加分时不要加到超过得分上限。
...
3. **<span style="color: #ff7575">登陆破解等待超过10秒或者玩的时候遇到报错就立刻关掉游戏， 然后看看设备/模拟器内的浏览器是不是能访问google.com，能则重进游戏即可，不能则切换代理节点/线路！</span>**
...
**付费模式为每月订阅（8~12美元/月）或一次性永久订阅（彻底私服，30美元左右）**，目前私服破解的大佬有：NK、TN、BX，三者已经达成合作，加快私服破解的开发进度。截止2025年9月4日，已正式发布13亿下载量庆典活动的最新版本私服破解。
