...
5. 每次开启破解时，都会从破解服务器读取破解的货币数量（球芒币、经验值、排球等），仅适用于破解球员加点，**<span style="color: #ff7575">一旦经过签到、比赛获胜等方式与正版服务器进行交互，则会读取正版服务器里的各类货币数量，此时不可对破解球员进行加点。 重新开启破解，即可再次从破解服务器读取破解的货币数量。</span>**
6. 根据第5点，建议开启破解后第一时间就给破解球员都进行加点，这些球员数据会保存到破解服务器中，下次启动无需再次加点。
7. 根据第5点，破解版中的球员招募可在读取正版服务器货币数量后进行。
8. 设置主力时，**<span style="color: #ff7575">不要在单个球员页面内设置，会闪退</span>**。球员管理界面左下角就可以直接设置主力
9. 正版进行大版本更新后（比如新活动新赛制出现），私服破解会在3~5天左右的时间进行版本对齐的破解版本更新，在此期间旧破解会被强制更新而无法使用，等待破解作者发布新版本即可。
## 如何购买密钥
