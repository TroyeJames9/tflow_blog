...
4. 破解包括全角色满突破与原版劳尔。**可用于所有比赛**！（注意，劳尔的能力值一旦被你调小，无法再加点），温馨提示：球员管理页面按等级排序时，左数第一个劳尔为新劳尔，第二个劳尔为旧劳尔。
5. 每次开启破解时，都会从破解服务器读取破解的货币数量（球芒币、经验值、排球等），仅适用于破解球员加点，**一旦经过签到、比赛获胜等方式与正版服务器进行交互，则会读取正版服务器里的各类货币数量，此时不可对破解球员进行加点。 重新开启破解，即可再次从破解服务器读取破解的货币数量。**
6. 根据第4点，建议开启破解后第一时间就给破解球员都进行加点，这些球员数据会保存到破解服务器中，下次启动无需再次加点。
7. 根据第4点，破解版中的球员招募可在读取正版服务器货币数量后进行。
8. 设置主力时，**不要在单个球员页面内设置，会闪退**。球员管理界面左下角就可以直接设置主力
