...
3. 破解包括全角色满突破与原版劳尔。**可用于所有比赛**！（注意，劳尔的能力值一旦被你调小，无法再加点），温馨提示：球员管理页面按等级排序时，左数第一个劳尔为新劳尔，第二个劳尔为旧劳尔。
...
7. 设置主力时，**不要在单个球员页面内设置，会闪退**。球员管理界面左下角就可以直接设置主力
8. 正版进行大版本更新后（比如新活动新赛制出现），私服破解会在3~5天左右的时间进行版本对齐的破解版本更新，在此期间旧破解会被强制更新而无法使用，等待破解作者发布新版本即可。
## 如何购买密钥
