...
- 按三次音量降低按钮即可启用自动获胜（autowin），破解数值上限功能
...
2. **<span style="color: #ff7575">登陆破解等待超过10秒或者玩的时候遇到报错就立刻关掉游戏， 然后看看模拟器内的浏览器是不是能访问google.com，以及 google play是否正常登陆，如果均正常，则重开游戏即可，不正常则切换魔法节点/线路，google play登陆</span>**
...
5. 正版进行大版本更新后（比如新活动新赛制出现），私服破解会在3~5天左右的时间进行版本对齐的破解版本更新，在此期间旧破解会被强制更新而无法使用，等待破解作者发布新版本即可。
## 如何购买密钥

> [!EXAMPLE] 需要代购？
> [联系tflow](杂记/如何联系tflow？.md)购买，提供安装包、密钥、一切资源和实时指导。

**付费模式为半私服每月订阅（6美元/月无autowin，8美元/月有autowin，无限数值）或纯私服永久订阅（18美元）**，目前私服破解的大佬有：NK、TN、BX，三者已经达成合作，加快私服破解的开发进度。截止2025年12月4日，已正式发布野兽劳尔活动的最新版本私服破解。
...
补充：**付费版离线破解可用球员包括正版所有可用球员+劳尔！** 但性价比仍然不如私服破解
