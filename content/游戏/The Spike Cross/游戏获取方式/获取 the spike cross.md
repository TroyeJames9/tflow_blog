...
> [!todo] TODO
> 1. 该部分教程暂时**仅针对安卓设备**，欢迎苹果用户贡献针对苹果设备的教程
> 2. 想在电脑上玩the spike？选择使用`mumuplayer12`或者`ldplayer 9` 等安卓模拟器，它们内置谷歌服务，本教程适用于安卓模拟器
> 3. 游戏发布STEAM版本时，将新增针对windows设备的教程
> 
...
配置代理有两种方式：使用傻瓜式VPN（付费或免费）、使用开源网络代理工具（比如mihomo）。

如果你从未学习并配置过代理，阅读[VPN](免费VPN.md)说明并开启代理，**后续步骤要确保代理一直处于开启状态**。
...
> - 务必要牢记账号和密码，强烈建议加上**两步验证（谷歌验证器）、备用码、辅助邮箱、辅助电话号**等安全措施，一旦丢失或被封号，很难找回账号
> - **如果手上可用的电话号注册均失败**，可选择：
...
如遇到问题请查阅[常见问题Q&A](游戏/The%20Spike%20Cross/常见问题Q&A.md)
